...
const ContestDashboard = () => {
  ...
  const handleUpload = async () => {
    try {
      ...
      const response = await instance.post(
        "/api/upload-submission/upload-files",
        { forData },
        {
          headers: {
      ...
      >
        <Center h="100%">
          ...
          >
            ...
            <Text fontSize="lg">
              Time Left: {contestDetails.monthsLeft} Months
            </Text>
          </VStack>
        </Center>
      </Box>
      ...
      >
        <HStack>
          <Tabs w="20%">
            <TabList>
              <Tab>
                <Text color="custom.white">Overview</Text>
              </Tab>
              <Tab>
                <Text color="custom.white">Leaderboard</Text>
              </Tab>
            </TabList>
          </Tabs>
          <Spacer />
          ...
          {showSubmissionTab && (
            <>
              <Tabs>
                <TabList>
                  <Tab>
                    <Text color="custom.white">Submission</Text>
                  </Tab>
                </TabList>
              </Tabs>
