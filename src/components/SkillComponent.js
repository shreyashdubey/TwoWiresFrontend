...
import { ADD_SKILL, GET_ALL_SKILL, DELETE_SKILL } from "../utils/endpoints";
  ...
  const fetchSkills = async () => {
    try {
      ...
      const response = await instance.get(
        `${GET_ALL_SKILL}?user=${userId}&page=1&pageSize=10`,
      );
      ...
      >
        ...
        <ModalContent bgColor="custom.mccolor">
          ...
          <ModalFooter>
            ...
            <Button bgColor="custom.mbutton" onClick={onClose}>
