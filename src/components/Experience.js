...
const Experience = () => {
  ...
  const formatDateRange = (startDate, endDate) => {
    ...
    return endDate ? `${startYear}-${endYear}` : `${startYear}-${endYear}`;
  };
    ...
    <Box mt={2}>
      ...
      <Modal isOpen={isOpen} onClose={handleCloseModal}>
        ...
        <ModalContent
          ...
          w={["300px", "300px", "380px", "600px", "700px"]}
        >
              ...
              <Box w="100%">
                ...
                >
                  ...
                  <Select
                    ...
                    onChange={(e) =>
                      handleInputChange("endMonth", e.target.value)
                    }
                  >
                    {months.map((month) => (
                      <option key={month} value={month}>
          ...
          <ModalFooter>
            ...
            <Button bgColor="custom.charcoal" onClick={handleCloseModal}>
              {" "}
              <Text color="custom.white">Cancel</Text>
            </Button>
          </ModalFooter>
        </ModalContent>
      </Modal>
      ...
      {educationData.map((education, index) => (
        <Card
          ...
          boxShadow="md"
          bgColor="custom.darkSlateBlue"
          w={["250px", "300px", "320px", "300px", "500px", "700px"]}
        >
          <HStack>
            ...
            <Button
              ...
              w="10%"
            >
              <Image boxSize="25px" objectFit="cover" src={edit} alt="plus" />
            </Button>
            <Button
          ...
          {education.Product && <Text>I have built {education.Product}</Text>}

          {education.location && education.locationType && (
            <Text>
              {education.location} ·{" "}
              {getLocationTypeLabel(education.locationType)}
            </Text>
          )}
