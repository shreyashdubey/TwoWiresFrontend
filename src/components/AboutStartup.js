    ...
    <Box minHeight='100vh' bgColor={'blackAlpha.900'}  w='full'>
      <Center>
       <Text  as='I' fontSize={['4xl' , '5xl' , '5xl' , '7xl', '8xl' , '9xl']}  fontWeight='medium'  h='30%' textShadow='4px 4px #1D4044'  >Sourced Startup</Text>
        ...
        <VStack  ml= {['400px' , '20px' , '30px' , '-40px', '30px' , '150px']}  mr= {['400px' , '0px' , '0px' , '0px', '30px' , '150px']}>
         <Box ref={ref}>
        <motion.div
           variants = {{
       ...
       {isabove425px ?(
              <HStack  height={['400px' , '700px' , '250px' , '150px', '200px' , '100px']} mt='100px' ml='100px' spacing={['200px' , '200px' , '20px' , '200px', '200px' , '200px']}  as='I'  >
          ...
          <VStack bgColor={'red.800'} mt='50px' w='100%' justifyContent='center' alignContent='center' >
            <Heading fontSize='3xl'>Vision</Heading>
              <Text  w='55%'>At SourcedStartup, our vision is rooted in alleviating the common challenges encountered by entrepreneurs throughout the startup journey. We aim to streamline the startup-building process by addressing key pain points and providing comprehensive solutions.</Text>
          </VStack>
       )}
      {isabove425px ?(
               <HStack  height={['400px' , '300px' , '400px' , '200px', '200px' , '100px']}  mt= {['400px' , '300px' , '200px' , '30px', '30px' , '30px']} ml='100px' spacing={['200px' , '200px' , '20px' , '95px', '95px' , '95px']}  as='I'  >
          ...
          <VStack bgColor={'blue.900'} mt='50px'>
        ...
        {isabove425px ?(
                <HStack  height={['800px' , '800px' , '800px' , '800px', '750px' ,'600px']}  mt= {['400px' , '300px' , '200px' , '100px', '100px' , '30px']} ml='100px'  spacing={['200px' , '200px' , '20px' , '40px', '10px' , '10px']} as='I' >
          ...
          <VStack bgColor={'green.900'} mt='50px' mb='50px' justifyContent='center' alignContent='center' flexDir={'column'}>
          ...
          <Text w='75%' >We are developing an advanced Judge AI that will evaluate proposed solutions from co-founders. This AI will provide objective ratings and create a systematic flow to transform these solutions into actionable plans for building successful startups.</Text>
                ...
                <Text w='75%' mr='20px' >SourcedStartup envisions fostering an open-source community where individuals can contribute to the step-by-step solutions required for startup development. Collaboration will be key, as community members join forces to build a supportive ecosystem for aspiring entrepreneurs.</Text>
                <Text w='75%' mr='20px'>To enhance the learning experience, our platform will feature a dynamic feed with posts from fellow creators. Stay updated on industry trends, gain insights from experienced entrepreneurs, and showcase your progress to build a following. This content and community platform will serve as a hub for knowledge exchange and networking within the startup community.</Text>
