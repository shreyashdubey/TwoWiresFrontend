...
const User = () => {
  ...
  return (
    <Flex
      ml={["400px", "10px", "30px", "210px", "300px", "400px"]}
      mt="100px"
      w="50%"
    >
              ...
              {!userData.data && userData.isFetching ? (
                ...
                <Stack spacing={3} direction={"column"}>
                  <Text fontSize="20" color="custom.white">
                    ...
                    {userData?.data?.middleName}&nbsp;{userData?.data?.lastName}
                  </Text>
                  {userData?.data?.tagLine ? (
                    <Text fontSize="15" color="custom.white">
                      {userData.data.tagLine}
                    </Text>
                  ) : null}
                  {userData?.data?.about ? (
                    <Text fontSize="12" color="custom.white">
                      {userData.data.about}
                    </Text>
                  ) : null}
          ...
          <ModalContent w={["300px", "300px", "380px", "600px", "700px"]}>
            ...
            <ModalFooter>
              ...
              <Button
                ...
                right="10px"
              >
                <Text color="custom.white">Update</Text>
              </Button>
            </ModalFooter>
          </ModalContent>
        </Modal>
